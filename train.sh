...
LAMBDA_EFFICIENCY="${LAMBDA_EFFICIENCY:-0.35}"
...
AREA_LAGRANGE_LR="${AREA_LAGRANGE_LR:-0.10}"
AREA_LAGRANGE_MIN="${AREA_LAGRANGE_MIN:-0.0}"
AREA_LAGRANGE_MAX="${AREA_LAGRANGE_MAX:-20.0}"
STEP_COST="${STEP_COST:-0.005}"
STEP_COST_AFTER_TARGET="${STEP_COST_AFTER_TARGET:-0.04}"
